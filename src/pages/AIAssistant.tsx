...
When suggesting styles, mention:
- The style name
- Why it suits them
- Approximate cost in Indian salons
- Maintenance tips
Format responses clearly with emojis for better readability. Keep each response under 200 words.`;
...
const AIAssistant = () => {
  const [messages, setMessages] = useState<Message[]>([
    { role: "ai", content: "Hi! I'm your AI Style Assistant powered by Gemini ✨\n\nTell me about your face shape, hair type, and the occasion — I'll suggest the perfect look for you! 💈" },
  ]);
  ...
  const handleSend = async (customMessage?: string) => {
    ...
    try {
      const aiResponse = await callGemini(messages, messageToSend);
